...
export function AboutEditor({ initialContent }: { initialContent: AboutContent }) {
  ...
  function handleSave() {
    if (!hasImage) {
      setMessage("صورة قسم من نحن مطلوبة قبل الحفظ")
      return
    }
