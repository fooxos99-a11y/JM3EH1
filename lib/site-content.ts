...
export const defaultHeroContent: HeroContent = {
  slides: [
    ...
    },
    {
      ...
      description: "نقدم دورات ودروس تعليمية لمساعدة المسلمين الجدد على تعلم أساسيات الدين",
    },
    {
      id: 3,
      ...
      description: "نوفر بيئة آمنة وداعمة للمسلمين الجدد للاندماج في المجتمع الإسلامي",
    },
  ],
